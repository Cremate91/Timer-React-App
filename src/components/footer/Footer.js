    ...
    render(){
        return (
            <footer className="bg-faded">
                <div className="row">
                    <div className="col-6 col-sm-3 col-md-2 align-self-center copyright">Copyright &copy;2017 <a rel="noreferrer noopener" target="_blank" href="http://www.cremate-dev.de">cremate-dev.de</a></div>
                    <div className="col-6 col-sm-3 offset-sm-6 col-md-2 offset-md-8 social-icons text-right">
